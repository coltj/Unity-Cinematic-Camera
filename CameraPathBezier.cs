/******************************************************************************/
/*!
\file      CameraPathBezier.cs
\author    Colt Johnson
\date      2013
\brief     This class deals with all things to do with building the path itself that your camera will follow
\par       History:  
...
public class CameraPathBezier : MonoBehaviour 
{
	...
	public enum viewmodes{
		usercontrolled,//rotations will be decided by the rotation of the control points
	...
	public float GetPathFOV(float t)
	{
		...
		return Mathf.Lerp(FOVA,FOVB,ct);
	}
	...
	public float GetPathPercentageAtPoint(CameraPathBezierControlPoint point)
	{
		...
		return ((float)index)/((float)numberOfControlPoints);
	}
